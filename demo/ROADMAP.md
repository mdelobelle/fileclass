...
| # | Take | Feature | Vault gains | Status |
| - | ---- | ------- | ----------- | ------ |
| 037 | A field that follows your canvas | `Canvas`: the graph as a source, the engine writing by itself, and the filters that narrow it | `Reading map.canvas` (six books, four edges) | |
