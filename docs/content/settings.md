...
| **Global fileClass** | Applied to every note that has no other binding — except the notes of the class folder, which declare classes rather than use them. Leave empty to disable. |
