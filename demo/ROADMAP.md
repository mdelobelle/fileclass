...
| 027 | Right-click your way through it | context menus on a note, in its text, on its tab, on a class note and on the class folder | — (works on the vault as 026 leaves it) | |
