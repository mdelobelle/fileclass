...
| 033 | Schema changed? the base follows | `Sync this class to its base`, and the base button that reads *Sync the base* while the class and its table disagree | — (works on the vault as 032 leaves it) | |
